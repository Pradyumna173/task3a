...
#ifndef EBOT_DOCKING__SRV__DETAIL__PASSING_SERVICE__FUNCTIONS_H_
#define EBOT_DOCKING__SRV__DETAIL__PASSING_SERVICE__FUNCTIONS_H_
...
/// Initialize srv/PassingService message.
/**
...
/// Finalize srv/PassingService message.
/**
...
/// Create srv/PassingService message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ebot_docking__srv__PassingService_Request__init().
...
/// Destroy srv/PassingService message.
/**
 * It calls
 * ebot_docking__srv__PassingService_Request__fini()
...
/// Check for srv/PassingService message equality.
/**
...
/// Copy a srv/PassingService message.
/**
...
/// Initialize array of srv/PassingService messages.
/**
...
/// Finalize array of srv/PassingService messages.
/**
 * It calls
 * ebot_docking__srv__PassingService_Request__fini()
...
/// Create array of srv/PassingService messages.
/**
 * It allocates the memory for the array and calls
 * ebot_docking__srv__PassingService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PassingService messages.
/**
 * It calls
 * ebot_docking__srv__PassingService_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PassingService message array equality.
/**
...
/// Copy an array of srv/PassingService messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ebot_docking__srv__PassingService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ebot_docking
...
/**
 * It calls
 * ebot_docking__srv__PassingService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ebot_docking
...
/**
 * It allocates the memory for the array and calls
 * ebot_docking__srv__PassingService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ebot_docking
...
/**
 * It calls
 * ebot_docking__srv__PassingService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // EBOT_DOCKING__SRV__DETAIL__PASSING_SERVICE__FUNCTIONS_H_
