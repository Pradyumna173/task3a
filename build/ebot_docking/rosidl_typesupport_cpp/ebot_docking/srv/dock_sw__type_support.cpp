...
static const _DockSw_Request_type_support_symbol_names_t _DockSw_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ebot_docking, srv, DockSw_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ebot_docking, srv, DockSw_Request)),
  }
};
...
{
  return &::ebot_docking::srv::rosidl_typesupport_cpp::DockSw_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ebot_docking, srv, DockSw_Request)() {
  return get_message_type_support_handle<ebot_docking::srv::DockSw_Request>();
}
...
static const _DockSw_Response_type_support_symbol_names_t _DockSw_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ebot_docking, srv, DockSw_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ebot_docking, srv, DockSw_Response)),
  }
};
...
{
  return &::ebot_docking::srv::rosidl_typesupport_cpp::DockSw_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ebot_docking, srv, DockSw_Response)() {
  return get_message_type_support_handle<ebot_docking::srv::DockSw_Response>();
}
...
static const _DockSw_type_support_symbol_names_t _DockSw_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ebot_docking, srv, DockSw)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ebot_docking, srv, DockSw)),
  }
};
...
{
  return &::ebot_docking::srv::rosidl_typesupport_cpp::DockSw_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ebot_docking, srv, DockSw)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ebot_docking::srv::DockSw>();
}
