...
static const _PassingService_Request_type_support_symbol_names_t _PassingService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ebot_docking, srv, PassingService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ebot_docking, srv, PassingService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ebot_docking, srv, PassingService_Request)() {
  return &::ebot_docking::srv::rosidl_typesupport_c::PassingService_Request_message_type_support_handle;
}
...
static const _PassingService_Response_type_support_symbol_names_t _PassingService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ebot_docking, srv, PassingService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ebot_docking, srv, PassingService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ebot_docking, srv, PassingService_Response)() {
  return &::ebot_docking::srv::rosidl_typesupport_c::PassingService_Response_message_type_support_handle;
}
...
static const _PassingService_type_support_symbol_names_t _PassingService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ebot_docking, srv, PassingService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ebot_docking, srv, PassingService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ebot_docking, srv, PassingService)() {
  return &::ebot_docking::srv::rosidl_typesupport_c::PassingService_service_type_support_handle;
}
