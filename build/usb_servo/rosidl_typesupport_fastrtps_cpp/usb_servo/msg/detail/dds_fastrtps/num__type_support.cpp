...
#include "usb_servo/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = usb_servo::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const usb_servo::msg::Num *>(
    untyped_ros_message);
...
{
  return &usb_servo::msg::typesupport_fastrtps_cpp::_Num__handle;
}
