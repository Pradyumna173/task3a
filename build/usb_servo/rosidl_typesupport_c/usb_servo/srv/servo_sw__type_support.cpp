...
static const _ServoSw_Request_type_support_symbol_names_t _ServoSw_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usb_servo, srv, ServoSw_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, usb_servo, srv, ServoSw_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, usb_servo, srv, ServoSw_Request)() {
  return &::usb_servo::srv::rosidl_typesupport_c::ServoSw_Request_message_type_support_handle;
}
...
static const _ServoSw_Response_type_support_symbol_names_t _ServoSw_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usb_servo, srv, ServoSw_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, usb_servo, srv, ServoSw_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, usb_servo, srv, ServoSw_Response)() {
  return &::usb_servo::srv::rosidl_typesupport_c::ServoSw_Response_message_type_support_handle;
}
...
static const _ServoSw_type_support_symbol_names_t _ServoSw_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usb_servo, srv, ServoSw)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, usb_servo, srv, ServoSw)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, usb_servo, srv, ServoSw)() {
  return &::usb_servo::srv::rosidl_typesupport_c::ServoSw_service_type_support_handle;
}
